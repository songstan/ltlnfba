...
mydump(Node *n)
{
	...
	switch(n->ntyp) {
	case OR:	myBinop("||"); break;
	case AND:	myBinop("&&"); break;
	case U_OPER:	myBinop("U");  break;
	case V_OPER:	myBinop("V");  break;
#ifdef NXT
	case NEXT:
		fprintf(dot, "X");
		fprintf(dot, " (");
